...
public class EdgeWeightedDigraph {
    ...
    /**
     * Initializes a random edge-weighted di_graph with {@code V} vertices and <em>E</em> edges.
     *
     * @param  V the number of vertices
    ...
    /**
     * Initializes an edge-weighted di_graph from the specified input stream.
     ...
     * @throws IllegalArgumentException if the end points of any edge are not in prescribed range
